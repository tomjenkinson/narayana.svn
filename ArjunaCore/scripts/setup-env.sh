...
JACORB_HOME=$JBOSSTS_HOME/jacorb
...
EXT_CLASSPATH="$EXT_CLASSPATH$CPS$JBOSSTS_HOME/lib/ext/log4j-1.2.14.jar"
EXT_CLASSPATH="$EXT_CLASSPATH$CPS$JBOSSTS_HOME/lib/ext/jboss-loggingjar"
...
JACORB_CLASSPATH="$JACORB_CLASSPATH$CPS$JACORB_HOME/lib/slf4j-jdk14-1.5.6.jar"
JACORB_CLASSPATH="$JACORB_CLASSPATH$CPS$JACORB_HOME/lib/slf4j-api-1.5.6.jar"
